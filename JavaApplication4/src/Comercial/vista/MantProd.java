...
//        cbx_bodega.setSelectedIndex(0);
    ...
    private void Btn_GuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Btn_GuardarActionPerformed
        ...
        Producto prodAInsertar = new Producto();
        prodAInsertar.setPKcodigoProducto(Txt_id.getText());
        prodAInsertar.setNombreProducto(Txt_nombreproducto.getText());
        prodAInsertar.setDescripcionProducto(Txt_descipcionproducto.getText());
        prodAInsertar.setPrecioProducto(Txt_precioproducto.getText());
        prodAInsertar.setCostoProducto(Txt_costoproducto.getText());
        prodAInsertar.setEstatusProducto(Txt_estadoproducto.getText());
        prodAInsertar.setLineaProducto(Txt_linea.getText());
        prodAInsertar.setMarcaProducto(Txt_marca.getText());
        prodAInsertar.setBodegaProducto(Txt_bodega.getText());
        prodAInsertar.setUnidadProducto(Txt_unidad.getText());
        prodDAO.insert(prodAInsertar);
    ...
    private void Btn_ModificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Btn_ModificarActionPerformed
        ...
        prodDAO.update(productoAActualizar);
