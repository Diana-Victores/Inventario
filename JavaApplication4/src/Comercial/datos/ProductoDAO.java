...
public class ProductoDAO {
    ...
    private static final String SQL_INSERT = "INSERT INTO tbl_producto(PK_codigo_producto, nombre_prodcuto, descripcion_producto, precio_producto, costo_producto, estatus_producto, PK_codigo_linea, PK_codigo_marca, PK_codigo_bodega, PK_codigo_unidad) VALUES(?,?,?,?,?,?,?,?,?,?,?,?)";
    private static final String SQL_SELECT = "SELECT PK_codigo_producto,nombre_prodcuto, descripcion_producto, precio_producto, costo_producto, estatus_producto, PK_codigo_linea, PK_codigo_marca, PK_codigo_bodega, PK_codigo_unidad FROM tbl_producto";
    private static final String SQL_QUERY = "SELECT PK_codigo_producto, nombre_prodcuto, descripcion_producto, precio_producto, costo_producto, estatus_producto, PK_codigo_linea, PK_codigo_marca, PK_codigo_bodega, PK_codigo_unidad FROM tbl_producto WHERE PK_codigo_producto = ?";
    private static final String SQL_UPDATE = "UPDATE tbl_producto SET PK_codigo_producto=?, nombre_prodcuto=?, descripcion_producto=?, precio_producto=?, costo_producto=?, estatus_producto=?, PK_codigo_linea=?, PK_codigo_marca=?, "
            + "PK_codigo_bodega=?, PK_codigo_unidad=?  WHERE PK_codigo_producto";
